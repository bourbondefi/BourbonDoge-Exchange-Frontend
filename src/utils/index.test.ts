...
describe('utils', () => {
  describe('#getEtherscanLink', () => {
    it('correct for tx', () => {
      expect(getBscScanLink(1, 'abc', 'transaction')).toEqual('https://explorer-mainnet-cardano-evm.c1.milkomeda.com/tx/abc')
    })
    it('correct for token', () => {
      expect(getBscScanLink(1, 'abc', 'token')).toEqual('https://explorer-mainnet-cardano-evm.c1.milkomeda.com/token/abc')
    })
    it('correct for address', () => {
      expect(getBscScanLink(1, 'abc', 'address')).toEqual('https://explorer-mainnet-cardano-evm.c1.milkomeda.com/address/abc')
    })
    it('unrecognized chain id defaults to mainnet', () => {
      expect(getBscScanLink(2, 'abc', 'address')).toEqual('https://explorer-mainnet-cardano-evm.c1.milkomeda.com/address/abc')
    })
    it('ropsten', () => {
      expect(getBscScanLink(3, 'abc', 'address')).toEqual('https://explorer-mainnet-cardano-evm.c1.milkomeda.com/address/abc')
    })
    it('enum', () => {
      expect(getBscScanLink(ChainId.RINKEBY, 'abc', 'address')).toEqual('https://explorer-mainnet-cardano-evm.c1.milkomeda.com/address/abc')
    })
  })
